...
echo "/lib/modules/$(uname -r)/extra/pvrsrvkm.ko: /lib/modules/$(uname -r)/extra/drm.ko" >>/tmp/modules.$$.tmp
	...
	install_file libpvrPVR2D_DRIWSEGL.so /usr/lib/libpvrPVR2D_DRIWSEGL.so.1.9.2188537 "shared library" 0644 0:0
	install_link libpvrPVR2D_DRIWSEGL.so.1.9.2188537 /usr/lib/libpvrPVR2D_DRIWSEGL.so

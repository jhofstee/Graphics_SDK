...
int main(int argc, char **argv)
{
	...
	*/
	...
	pi32ConfigAttribs[2] = EGL_RED_SIZE;
	pi32ConfigAttribs[3] = 8;
	pi32ConfigAttribs[4] = EGL_GREEN_SIZE;
	pi32ConfigAttribs[5] = 8;
	pi32ConfigAttribs[6] = EGL_BLUE_SIZE;
	pi32ConfigAttribs[7] = 8;
	pi32ConfigAttribs[8] = EGL_ALPHA_SIZE;
	...
	*/
	EGLint i32Total_num_configs, j, num_config;
	EGLint value;
	EGLConfig* pConfigs;
	...
	/*
		...
		memory.
	*/
	eglSurface = eglCreateWindowSurface(eglDisplay, eglConfig, (NativeWindowType) EWSWindow, NULL);

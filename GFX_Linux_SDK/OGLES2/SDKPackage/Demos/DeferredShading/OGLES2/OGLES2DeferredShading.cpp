...
bool OGLES2DeferredShading::RenderScene()
{
	...
	m_Print3D.DisplayDefaultTitle("Deferred Shading", c_pszRenderModes[m_RenderMode], ePVRTPrint3DLogoIMG);	
...
bool OGLES2DeferredShading::AllocateGBuffer(CPVRTString *pErrorStr)
{
	...
	bool bDiscardSupported = CPVRTgles2Ext::IsGLExtensionSupported("GL_EXT_discard_framebuffer");
	if (bDiscardSupported)
		bDiscardSupported = m_sExtensions.glDiscardFramebufferEXT != 0;		
	
	// Temporarily disabled
	bDiscardSupported = false;
